...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ITIS features */
        {"itis", "masternode", &masternode, true, true, false},
        {"itis", "masternodelist", &masternodelist, true, true, false},
        {"itis", "mnbudget", &mnbudget, true, true, false},
        {"itis", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"itis", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"itis", "mnsync", &mnsync, true, true, false},
        {"itis", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"itis", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use itisd, or the -server option to itis-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> itis-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:60111/\n";
}
